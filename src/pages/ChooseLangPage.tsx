    ...
    return (
        <div style={{ display: "flex", alignItems: "center", flexDirection: "column", color: "#6D6D6D" }}>
            <p style={{ marginTop: 120, textAlign: "left", width: 320 }}>
                Escolha o <span style={{ color: "#FD8087", fontWeight: "bold" }}>Idioma Alvo</span> (aquele que você deseja aprender) durante a partida!
            </p>
            <Select styles={customStyles} options={targetLangOptions} />
            <p style={{ marginTop: 25, textAlign: "left", width: 320 }}>
                E o <span style={{ color: "#8AC9FE", fontWeight: "bold" }}>Idioma Origem</span> (aquele pelo qual você deseja aprender) durante a partida!
            </p>
